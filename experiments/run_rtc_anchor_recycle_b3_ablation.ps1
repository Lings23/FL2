...
$freeze = Join-Path $workspace 'config\rtc_v3_anchor_recycle_b3.freeze.json'
$output = Join-Path $workspace 'logs\rtc_v3_anchor_recycle_b3_seed42_mf03'
...
if ($LASTEXITCODE -ne 0) {
    throw "RTC B3 anchor-recycle ablation failed with exit code $LASTEXITCODE"
}
