...
$freeze = Join-Path $workspace 'config\rtc_v3_cumulative_q_cap.freeze.json'
$output = Join-Path $workspace 'logs\rtc_v3_cumulative_q_cap_seed42_mf03'
...
if ($LASTEXITCODE -ne 0) {
    throw "RTC cumulative-q cap ablation failed with exit code $LASTEXITCODE"
}
