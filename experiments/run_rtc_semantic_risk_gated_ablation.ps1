...
$output = Join-Path $workspace 'logs\rtc_v3_semantic_risk_gated_seed42_mf03'
...
$arguments = @(
    ...
    '--attacks', 'lie,dba',
    '--defenses', 'rtc_semantic_risk_gated',
...
if ($LASTEXITCODE -ne 0) {
    throw "RTC semantic risk-gated ablation failed with exit code $LASTEXITCODE"
}
